...
export default function App() {
  ...
  useEffect(() => {
    fetch("https://ats-resume-analyzer-1-t2kq.onrender.com/health")
      .then((res) => {
    ...
    <>
      <style>{`
        * { box-sizing: border-box; }
        ...
        .fade-in { animation: fadeInUp 0.65s ease forwards; }
            ...
            <div style={styles.hero}>
              <div style={styles.heroText}>
                ...
                <p style={styles.subtitle}>
                  ...
                  matched keywords, missing keywords, strengths, and improvements in a modern,
              ...
              <div style={styles.heroCard} className="float-card">
          ...
          <div style={styles.workspace} className="grid-responsive">
            <div style={styles.card} className="fade-in">
              ...
              <button
                style={{
                  ...styles.analyzeBtn,
                  opacity: resumeFile && !isLoading ? 1 : 0.6,
              ...
              {isLoading && (
                <div style={styles.loaderCard} className="slide-in">
                  ...
                  <p style={styles.cardSub}>
                    Uploading PDF, extracting text, and generating ATS analysis
                  </p>
